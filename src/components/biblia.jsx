		...
		<>
			<div className="h-full w-full bg-gray-700 border-2 border-gray-50 rounded-xl p-5">
				...
				<h2>
					...
					reservada a coroa da justiça, que o Senhor, justo Juiz, me dará
					naquele dia; e não somente a mim, mas também a todos os que amam a sua
					vinda. Combati o bom combate, terminei a corrida, guardei a fé. Agora
					me está reservada a coroa da justiça, que o Senhor, justo Juiz, me
					dará naquele dia; e não somente a mim, mas também a todos os que amam
					a sua vinda. Combati o bom combate, terminei a corrida, guardei a fé.
