		...
		<>
			<div className=" flex flex-col justify-center items-center  bg-gray-950 h-[100vh] w-full gap-4">
				...
				<div className="flex flex-col lg:flex-row lg:max-h-[84%] w-full gap-4 p-4">
					<button
						className="lg:hidden  fixed top-7 right-2 z-30 bg-gray-800 text-white p-2 rounded"
					...
					<div
                        ...
                        `}
					>
						<div className="flex flex-col max-h-[51vh] overflow-y-auto md:h-[43%] lg:h-[84%] w-full bg-gray-800 rounded-xl   text-3xl font-bold text-blue-500 gap-1 p-5 pt-8 ">
							<button
