	...
	return (
		<div className="flex flex-col h-full w-full bg-gray-700 gap-2">
			...
			<div className="sticky top-0 z-10 bg-gray-700 pt-2">
				<h1 className="text-xl font-bold ml-3 mt-0 text-blue-500">Fale com o Croq</h1>
				<hr className="border border-gray-50 my-4" />
			</div>

			{/* Área rolável */}
			<div className="flex-1 overflow-auto px-4 rounded min-h-[80px] h-[75%] text-blue-500">
				{resposta ? <p>{resposta}</p> : <p>Aguardando sua pergunta</p>}
			</div>

			{/* Input e botão fixos abaixo */}
